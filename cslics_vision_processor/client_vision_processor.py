...
class CslicsClient:
    ...
    def process_image_neural(self, frame: numpy.ndarray) -> None:
        ...
        self.client.publish(self.topic_boxes, comms.BoxesMessage(self.image_index, 0.0, results.boxes.xyxyn).pack())
        self.client.publish(self.topic_counts, comms.CountsMessage(self.image_index, 0.0, counts).pack())
